package com.management.account.accountmanagement.config;
...
public class SwaggerConfig {
    final Logger LOGGER = LoggerFactory.getLogger(SwaggerConfig.class);

    @Bean
    public Docket eDesignApi(SwaggerConfigProperties swaggerConfigProperties) {
        LOGGER.info("Swagger configuration:: LOADED");
    ...
    UiConfiguration uiConfig(SwaggerConfigProperties swaggerConfigProperties) {
        LOGGER.info("Swagger UI configuration:: LOADED");
